...
import { Building, Car, Shirt } from "lucide-react"
import { Card, CardContent } from "../components/ui/card"
  ...
  return (
    <div className="container py-12">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-6 rounded-lg mb-8">
          <h2 className="text-xl font-bold mb-2">What would you like to rent out?</h2>          <p className="text-muted-foreground mb-4">Select the category that best matches your rental item</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-lg">Car</h3>
              <p className="text-sm text-muted-foreground mt-2">
                Luxury, SUVs, economy, vans, and other vehicles
              </p>
            </CardContent>
          </Card>
        ...
        {activeCategory === "property" && <PropertyUpload />}
        {activeCategory === "car" && <CarUpload />}
        {activeCategory === "clothing" && <ClothingUpload />}
      </div>
    </div>
  )
}
